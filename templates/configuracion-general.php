  ...
  <div class="row">
    <div class="col-md-7">
      <div class="row">
        ...
        <div class="col-6 mb-1">
          Pantalla de Login - Color de fondo:
        </div>
        <div class="col-6 mb-1">
          <input type="color" class="form-control" name="color_fondo">
        </div>
        <div class="col-6 mb-1">
          Pantalla de Login - Color de texto:
        </div>
        <div class="col-6 mb-1">
          <input type="color" class="form-control" name="color_texto">
        </div>
        <div class="col-6 mb-1">
...
$.post(url,data,function(raw){
  ...
  if(response.status!="OK") {
    ...
    window.location.href = "./?s=configuracion-general&msg=3&id=" + obj.id;
  }
}).fail(function(){
  alert("No funciono");
});
...
$.post(url,data,function(raw){
  ...
  if(response.status!="OK") {
    ...
    window.location.href = "./?s=configuracion-general&msg=4&id=" + obj.id;
  }
}).fail(function(){
  alert("No funciono");
});
...
$(document).on('click','#guardar-btn',function(e){
  ...
  $.post(url,data,function(response_raw){
    ...
    if(response.mensaje!="OK") {
      ...
      window.location.href = "./?s=configuracion-general&msg=1";
    }
  }).fail(function(){
    alert("No funciono");
  });
