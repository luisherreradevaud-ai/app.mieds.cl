...
try {
  ...
  $comision = new TurnoComision($_POST['id'] ?? null);
  $comision->setPropertiesNoId($_POST);
  $comision->id_turnos = $_POST['id_turnos'];

  if($comision->id == "") {
    $comision->creado_por = $GLOBALS['usuario']->id;
  }
  ...
  echo json_encode(array(
    'status' => 'OK',
    'mensaje' => 'Comisión guardada exitosamente',
    'id' => $comision->id
  ));
